package com.bank.bian.prospectcampaigndesign.model;
...
/**
 * The BIAN control record for this service domain: "Prospect Campaign Design".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Design) applied
 * to its asset type (Prospect Campaign). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Prospect Campaign Design";
